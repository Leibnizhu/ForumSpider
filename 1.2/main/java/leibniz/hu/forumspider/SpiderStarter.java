...
public class SpiderStarter {
	...
	public void startSpider(String propPath) {
		...
		try {
			...
			Spider.create(new ImgPageProcessor(prop.getProperty("URL_LIST"), prop.getProperty("URL_POST"), prop.getProperty("URL_IMG"), prop.getProperty("POST_IGNORE"), prop.getProperty("TITLE_IGNORE"), prop.getProperty("LIST_FLAG"), prop.getProperty("POST_FLAG")))
